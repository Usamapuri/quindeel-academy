...
const SETTINGS: Record<string, string> = {
  ...
  // Split hero (home page). All inline-editable.
  heroBadgeEn: "39+ Years of Excellence", heroBadgeUr: "انتالیس سالہ شاندار تجربہ",
  heroStat1ValueEn: "39+", heroStat1ValueUr: "39+",
  heroStat1LabelEn: "Years teaching", heroStat1LabelUr: "سال تدریس",
  heroStat2ValueEn: "5,000+", heroStat2ValueUr: "5,000+",
  heroStat2LabelEn: "Students taught", heroStat2LabelUr: "پڑھائے گئے طلبہ",
  heroStat3ValueEn: "10+", heroStat3ValueUr: "10+",
  heroStat3LabelEn: "Programs offered", heroStat3LabelUr: "پیش کردہ پروگرام",
  heroCred1En: "39+ years in education, including Cadet Colleges",
  heroCred1Ur: "کیڈٹ کالجز سمیت تعلیم میں انتالیس سال کا تجربہ",
  heroCred2En: "O Level & A Level Urdu specialist", heroCred2Ur: "او لیول اور اے لیول اردو کے ماہر",
  heroCred3En: "CSS/PMS competitive exam Urdu expert", heroCred3Ur: "سی ایس ایس / پی ایم ایس اردو کے ماہر",
  heroCred4En: "Teacher-training workshop organizer", heroCred4Ur: "اساتذہ تربیتی ورکشاپس کے منتظم",
